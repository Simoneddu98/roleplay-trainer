import {
  ...
  Share2, Bot, PenTool, ClipboardCheck, Leaf, Shield, Sparkles, Wind, Bug,
  AlertTriangle, AlertOctagon, FileSearch,
} from 'lucide-react';

const iconMap: Record<string, React.ComponentType<{ className?: string }>> = {
  HandCoins, MessageSquareWarning, UserPlus, Share2, Bot, PenTool,
  ClipboardCheck, Leaf, Shield, Sparkles, Wind, Bug, AlertTriangle, AlertOctagon, FileSearch,
};
...
const categoryColors: Record<string, string> = {
  ...
  Sicurezza: 'bg-red-500/15 text-red-400 border-red-500/20',
  Audit: 'bg-orange-500/15 text-orange-400 border-orange-500/20',
  Compliance: 'bg-amber-500/15 text-amber-400 border-amber-500/20',
  Ambiente: 'bg-emerald-500/15 text-emerald-400 border-emerald-500/20',
  'Qualità': 'bg-blue-500/15 text-blue-400 border-blue-500/20',
};
